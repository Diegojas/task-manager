...
<head>
    ...
    <title>Laravel Task Manager Documentation</title>
...
<div class="tocify-wrapper">
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="task-management">
                    <a href="#task-management">Task Management</a>
                                ...
                                <a href="#task-management-GETapi-tasks">List all tasks for authenticated user</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="task-management-POSTapi-tasks">
                                <a href="#task-management-POSTapi-tasks">Create a new task for authenticated user</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="task-management-GETapi-tasks--id-">
                                <a href="#task-management-GETapi-tasks--id-">Get a specific task by ID for authenticated user</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="task-management-PUTapi-tasks--id-">
                                <a href="#task-management-PUTapi-tasks--id-">Update a specific task</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="task-management-DELETEapi-tasks--id-">
                                <a href="#task-management-DELETEapi-tasks--id-">Delete a specific task</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="task-management-GETapi-stats">
                                <a href="#task-management-GETapi-stats">Get Statistics of Tasks</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
    ...
    <ul class="toc-footer" id="last-updated">
        <li>Last updated: December 9, 2023</li>
    </ul>
</div>
...
<p>You can retrieve your token by registering from the api</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The password of the user. Minimum 6 characters. Example: <code>password</code></p>
        </div>
        </form>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>APIs for managing tasks</p>
                                ...
                                <h2 id="task-management-GETapi-tasks">List all tasks for authenticated user</h2>
...
<span id="example-responses-GETapi-tasks">
            <blockquote>
            <p>Example response (200, when authenticated):</p>
        </blockquote>
                <pre>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="task-management-POSTapi-tasks">Create a new task for authenticated user</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The title of the task. Example: <code>Finish homework</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               value="Math, Literature and Sciences"
               data-component="body">
    <br>
<p>The description of the task. Example: <code>Math, Literature and Sciences</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The status of the task. Example: <code>pending</code></p>
        </div>
        </form>

                    <h2 id="task-management-GETapi-tasks--id-">Get a specific task by ID for authenticated user</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/tasks/9" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/tasks/9"
);
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the task. Example: <code>9</code></p>
            </div>
                    <div style="padding-left: 28px; clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="task"                data-endpoint="GETapi-tasks--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the task. Example: <code>1</code></p>
                    ...
                    <h2 id="task-management-PUTapi-tasks--id-">Update a specific task</h2>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="task"                data-endpoint="PUTapi-tasks--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the task. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="Finish homework updated"
               data-component="body">
    <br>
<p>The new title of the task. Example: <code>Finish homework updated</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               value="Just Literature"
               data-component="body">
    <br>
<p>The new description of the task. Example: <code>Just Literature</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The new status of the task. Example: <code>completed</code></p>
        </div>
        </form>

                    <h2 id="task-management-DELETEapi-tasks--id-">Delete a specific task</h2>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="task"                data-endpoint="DELETEapi-tasks--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the task that needs to be deleted. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="task-management-GETapi-stats">Get Statistics of Tasks</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Fetch statistics related to the tasks of the authenticated user.</p>
...
<br>
                        ...
                        <b style="line-height: 2;"><code>totalTasks</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
<br>
<p>Total number of tasks the user has</p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
                        <b style="line-height: 2;"><code>pendingTasks</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
<br>
<p>Total number of tasks with 'pending' status</p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
                        <b style="line-height: 2;"><code>newTasks</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
<br>
<p>Number of newly created tasks in the past week</p>
                    </div>
                                    </details>
        </div>
